...
namespace Dashboard.ViewModel
{
    public class HtmlRichTextBoxBehavior : DependencyObject
    {
        ...
        public static string GetText(RichTextBox textBox) { return (string)textBox.GetValue(TextProperty); }

        public static void SetText(RichTextBox textBox, string text) { textBox.SetValue(TextProperty, text); }
